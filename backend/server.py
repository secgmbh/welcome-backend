    ...
    try:
        ...
        return {
            ...
            "properties": [{
                ...
                "image_url": getattr(p, 'image_url', None) or "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=400&fit=crop",
                "wifi_name": getattr(p, 'wifi_name', None) or "Guest-WiFi-Seeblick",
                "wifi_password": getattr(p, 'wifi_password', None) or "Willkommen2026!",
